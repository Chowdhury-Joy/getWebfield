...
Last Updated: 2026-08-04T07:52:32Z
...
## Tech Stack
- Fonts: getWebfield Large + Inter (Bunny); `v2/css/design-tokens.css`
- Framer (Monocromo): canvas + CMS; Geist Mono
- HTML V1 (Green Company): IBM Plex Mono; olive green `#3a4632`
- HTML V2 (Farmio look + TLS content): getWebfield Large (Inter); Farmio lime `#e7f352`, cream `#e3e4d4`, ink `#04303b`; floating pill nav; marquee about; solution/service panels; map retained
...
- V2 solutions — stair-step cards with extras 0/120/240 (360/480/600); equal full-width on mobile; no Contact us in this section
